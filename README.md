...
- [IP-Collector](#ip-collector)
  ...
  * [Einleitung](#einleitung)
    + [Daten](#daten)
      ...
      - [Zeit](#zeit)
      - [ISP](#isp)
      - [Geographische Daten](#geographische-daten)
    + [Aufbau der Webseite](#aufbau-der-webseite)
      - [Home](#home)
      - [View Data](#view-data)
      - [View Diagramm](#view-diagramm)
      - [Compare](#compare)
      - [Implementierung](#implementierung)
    + [Server](#server)
      - [tarten des Servers](#tarten-des-servers)
      ...
      - [FlaskServer](#flaskserver)
        * [Routen:](#routen-)
          + [Route: “/”](#route-----)
          + [Route: “/diagram/*” (View Diagramm)](#route----diagram-----view-diagramm-)
          + [Route: “/compare/*” (Compare)](#route----compare-----compare-)
          + [Route: “/data/*” (ViewData)](#route----data-----viewdata-)
    ...
    + [Client](#client)
      - [Android](#android)
        * [Stündlicher](#st-ndlicher)
        * [WhatsApp](#whatsapp)
      - [IOS](#ios)
  * [Auswertung](#auswertung)
    + [Measurement](#measurement)
      - [Distance Hour](#distance-hour)
      - [Distance Minutes](#distance-minutes)
      - [Day](#day)
      - [Time](#time)
    + [Address Distribution](#address-distribution)
      - [IP-Addresses distribution](#ip-addresses-distribution)
      - [IP-Addresses distribution in trace](#ip-addresses-distribution-in-trace)
      - [ISP distribution](#isp-distribution)
      - [ISP distribution in trace](#isp-distribution-in-trace)
    + [Address / Time:](#address---time-)
      - [IP / Hour:](#ip---hour-)
      - [IP in trace / Hour](#ip-in-trace---hour)
      - [ISP / Hour](#isp---hour)
      - [ISP in trace / Hour](#isp-in-trace---hour)
    + [Changes in Adress:](#changes-in-adress-)
      - [IP Address changes](#ip-address-changes)
      - [IP Address changes / Hour](#ip-address-changes---hour)
      - [IP Address changes / Hour / Frequency](#ip-address-changes---hour---frequency)
      - [ISP changes](#isp-changes)
      - [ISP changes graph](#isp-changes-graph)
      - [ISP changes / Hour](#isp-changes---hour)
